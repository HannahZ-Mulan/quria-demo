    ...
    <div className="deep-space relative min-h-screen p-6 py-12">
      ...
      <div className="relative z-10 max-w-4xl mx-auto space-y-6">
        ...
        <Tabs defaultValue="p1-prd" className="w-full">
          <div className="flex justify-center">
            <TabsList className="grid h-auto w-full grid-cols-2 gap-2 rounded-2xl border border-white/10 bg-white/[0.04]! p-2 backdrop-blur-sm sm:flex sm:h-9 sm:w-auto sm:flex-nowrap sm:justify-center">
