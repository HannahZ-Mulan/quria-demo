...
/**
 * 通用徽章/小标签组件。常用来显示状态、分类、计数等。
 *
 * @param className - 额外追加的类名
 * @param variant - 颜色风格：default/secondary/destructive/outline/ghost/link
 * @param asChild - 为 true 时把样式套到传入的子元素上，而不是渲染 <span>
 * @param props - 其他原生 span 属性
 */
function Badge({
  className,
  variant = "default",
